 ...
 * Return: return value
 */
char *mz_getenv(info_t *info, const char *name)
{
 ...
 * Return: 0 Always
 */
int mz_populate_env_list(info_t *info)
{
lismz_t *node = NULL;
size_t i;
for (i = 0; environ[i]; i++)
