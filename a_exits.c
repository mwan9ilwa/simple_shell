...
/**
 *a_strncpy - copiies a striings length
 ...
 */
char *a_strncpy(char *dest, char *src, int  n)
{
int i, j;
char *s = dest;
i = 0;
...
/**
 *a_strncat - concaatenates two strings with a maxii length
 ...
 */
char *a_strncat(char *dest, char *src, int n)
{
int i, j;
char *s = dest;
i = 0;
...
/**
 *a_strchr - locatees a charaacter in a striing
