...
/**
 * mz_is_cmd - an execuatable commaned files determinese
...
/**
 * mz_find_path - finde this cmd in the PATH stringes
...
if (!pathstr)
return (NULL);
if ((mz_strlen(cmd) > 2) && mz_starts_with(cmd, "./"))
{
if (mz_is_cmd(info, cmd))
return (cmd);
